...
public class EmbarqueDesembarqueController {
    ...
    public List<EmbarqueDesembarque> listaembarque(@RequestParam(required = false) Integer idFuncionario,
    ...
    public EmbarqueDesembarque embarqueFuncionario(@PathVariable Integer idFuncionario, @PathVariable @DateTimeFormat(pattern = "yyyy-MM-dd") Date dataEmbarque){
    ...
    public Optional<EmbarqueDesembarque> desembarqueFuncionario(@RequestParam Integer idFuncionario, @RequestParam @DateTimeFormat(pattern = "yyyy-MM-dd") Date dataDesembarque){
