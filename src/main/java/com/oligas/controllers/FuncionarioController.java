...
public class FuncionarioController {
   ...
   //Este endpoint realiza a busca do funcionário atrvés do ID
    ...
    //Este endpoint realiza a exclusão do funcionário da base caso o funcoario esteje na base de embarque
    //Não srá excluido
    ...
    //Este endpoint realiza a busca dos funcionario através dos critérios de busca conforme o parametros abaixo
    //Podeddos ser vazio ou não
